...
int
spdk_bdev_open_ext2(const char *bdev_name, bool write, spdk_bdev_event_cb_t event_cb,
		    void *event_ctx, struct spdk_bdev_open_opts *opts,
		    struct spdk_bdev_desc **_desc)
{
	int rc;
...
{
	return spdk_bdev_open_ext2(bdev_name, write, event_cb, event_ctx, NULL, _desc);
}
