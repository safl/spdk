...
#define DEFAULT_MAX_IO_QUEUES_INTERRUPT	(256)
...
int nvme_transport_ctrlr_enable_interrupt(struct spdk_nvme_ctrlr *ctrlr);
...
int nvme_transport_qpair_get_efd(struct spdk_nvme_ctrlr *ctrlr, struct spdk_nvme_qpair *qpair);
