 ...
 * proceed.
 * \param event_ctx param for event_cb.
 * \param opts Option for (synchronous) block device open. If NULL, default values are used.
 * \param desc output parameter for the descriptor when operation is successful
 * \return 0 if operation is successful, suitable errno value otherwise
 */
int spdk_bdev_open_ext2(const char *bdev_name, bool write, spdk_bdev_event_cb_t event_cb,
