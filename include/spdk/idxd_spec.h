...
#define IDXD_DIF_SOURCE_FLAG_SOURCE_REFERENCE_TAG_TYPE		(1 << 7)
#define IDXD_DIF_SOURCE_FLAG_REFERENCE_TAG_CHECK_DISABLE	(1 << 6)
#define IDXD_DIF_SOURCE_FLAG_GUARD_CHECK_DISABLE			(1 << 5)
#define IDXD_DIF_SOURCE_FLAG_SOURCE_APPLICATION_TAG_TYPE	(1 << 4)
#define IDXD_DIF_SOURCE_FLAG_APPLICATION_AND_REFERENCE_TAG_F_DETECT	(1 << 3)
#define IDXD_DIF_SOURCE_FLAG_APPLICATION_TAG_F_DETECT		(1 << 2)
#define IDXD_DIF_SOURCE_FLAG_ALL_F_DETECT					(1 << 1)
#define IDXD_DIF_SOURCE_FLAG_ENABLE_ALL_F_DETECT_ERROR		(1)
