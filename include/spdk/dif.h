 ...
 * should be extended LBA payload. There is one limitation that DIF has to be at the last byte
 * of the metadata if PRACT is enabled and metadata size is larger than DIF size.
