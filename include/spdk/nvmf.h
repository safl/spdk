...
/**
 * Update discovery log. This sends discovery log page change notice to all
 * the controllers in the target's discovery subsystem associated with host
 * 'hostnqn'.
 *
 ...
 */
void spdk_nvmf_update_discovery_log(struct spdk_nvmf_tgt *tgt, const char *hostnqn);
